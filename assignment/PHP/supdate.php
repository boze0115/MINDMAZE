<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE `student` SET `Name` = '$name', `Password` = '$password', `EmailAddress` = '$email', `PhoneNum` = '$phone_number' WHERE `User_Name` = '$username'";
        
        if (mysqli_query($conn, $sql)) {
            // Redirect back to the profile page with success message
            header("Location: sprofile-edit.php?success=1");
            exit();
        } else {
...
<body>
    <header class="container">
        ...
        <nav>
            ...
            <a href="../PHP/sprofile-edit.php">VIEW PROFILE</a>
