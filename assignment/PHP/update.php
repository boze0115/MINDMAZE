<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE `admin` SET `Name` = '$name', `Password` = '$password', `EmailAddress` = '$email', `PhoneNum` = '$phone_number' WHERE `Admin_Name` = '$username'";
...
<body>
    <header class="container">
        ...
        <nav>
            ...
            <a href="../PHP/profile-edit.php">VIEW PROFILE</a>
